...
export const PRODUCTS: Product[] = [
  {
    ...
    hue: 205, tags: ['Travel-friendly', 'Foldable', 'Heavy-duty', '4-wheel'], bestSeller: true, overallPick: true,
  },
  {
    ...
    hue: 212, tags: ['Travel-friendly', 'Foldable', 'Compact', '4-wheel'],
  },
  {
    ...
    hue: 25, tags: ['Zero-gravity', 'Power recline', 'Heavy-duty'], bestSeller: true, overallPick: true,
  },
  {
    ...
    hue: 32, tags: ['3-position', 'Heat & massage', 'Value'],
  },
  {
    ...
    hue: 160, tags: ['Hi-low', 'Fall safety', 'White-glove setup'], overallPick: true,
  },
  {
    ...
    hue: 152, tags: ['Full electric', 'Value', 'Heavy-duty'],
  },
  {
    ...
    hue: 265, tags: ['Seat elevation', 'Long range', 'Premium'], bestSeller: true, overallPick: true,
  },
  {
    ...
    hue: 258, tags: ['Foldable', 'Compact', 'Transportable'],
  },
  {
    ...
    hue: 190, tags: ['Budget', 'Tub transfer', 'Heavy-duty'], bestSeller: true, overallPick: true,
  },
  {
    ...
    hue: 330, tags: ['Battery backup', 'Pro install', 'Swivel seat'], overallPick: true,
  },
]
